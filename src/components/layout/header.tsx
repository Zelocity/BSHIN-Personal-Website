...
function Header() {
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      /*
       * Contact is the final section, so activate it
  ...
  return (
    ...
    >
      {/*
        This uses the same 12-column layout as your sections.
        The actual header content occupies columns 3 through 10.
      */}
      <div
        className="
